...
/**
 * @fileOverview Summarizes the uploaded document so that the user can quickly understand the document's main points.
 *
...
You will summarize the document that is provided. Use the following as the primary source of information about the document.
